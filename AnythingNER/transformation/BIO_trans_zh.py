...
def tokenize_character_based(text):
    return list(text)
...
if __name__ == "__main__":
    input_directory = "./AnythingNER/balanced/zh/GEIC"
    output_directory = "./AnythingNER/balanced/zh/BIO"
